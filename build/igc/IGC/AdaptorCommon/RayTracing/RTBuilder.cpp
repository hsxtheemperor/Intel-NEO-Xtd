...
RTBuilder::SyncStackPointerVal* RTBuilder::getSyncStackPointer(Value* syncStackOffset, RTBuilder::RTMemoryAccessMode Mode)
{
    ...
    if (Mode == RTBuilder::STATEFUL)
    {
        ...
        Value* perLaneStackPointer = this->CreateIntToPtr(syncStackOffset, IGCLLVM::getPointerType(PointeeTy, AddrSpace));
    ...
    else
    {
        ...
        perLaneStackPointer = this->CreateIntToPtr(perLaneStackPointer, IGCLLVM::getPointerType(PointeeTy, ADDRESS_SPACE_GLOBAL));
        return static_cast<RTBuilder::SyncStackPointerVal*>(perLaneStackPointer);
    }
}
