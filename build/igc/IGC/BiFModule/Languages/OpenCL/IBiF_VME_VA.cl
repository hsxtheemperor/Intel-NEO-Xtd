    ...
    sampler_t vmeAccelerator )
{
   ...
   long srcImageInt = (long)(size_t)__builtin_astype(srcImage, void*);
   long refImageInt = (long)(size_t)__builtin_astype(refImage, void*);
    ...
    unsigned MaxPredMVs) // either 4 or 8
{
    ...
    long srcImgInt = (long)(size_t)__builtin_astype(srcImg, void*);
    long refImgInt = (long)(size_t)__builtin_astype(refImg, void*);
...
static INLINE GRFHandle ReadPixels(read_only image2d_t intraSrcImage, int2 coord, int width, int height)
{
    ...
    long intraSrcImageInt = (long)(size_t)__builtin_astype(intraSrcImage, void*);
    ...
    uint MaxSkipMVs)
{
    ...
    long srcImageInt = (long)(size_t)__builtin_astype(srcImage, void*);
    long refImage0Int = (long)(size_t)__builtin_astype(refImage0, void*);
    long refImage1Int = (long)(size_t)__builtin_astype(refImage1, void*);
