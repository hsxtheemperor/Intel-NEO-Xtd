...
void HandleLoadStoreInstructions::visitLoadInst(llvm::LoadInst& I)
{
            ...
            cast<VectorType>(I.getType())->getElementType()->isDoubleTy()))
    {
        ...
        {
            llvm::Type* floatyptr = IGCLLVM::getPointerType(builder.getFloatTy(), as);
        ...
        else
        {
            ...
            llvm::PointerType* ptrType = IGCLLVM::getPointerType(dataType, ptrv->getType()->getPointerAddressSpace());
...
void HandleLoadStoreInstructions::visitStoreInst(llvm::StoreInst& I)
{
            ...
            cast<VectorType>(I.getValueOperand()->getType())->getElementType()->isDoubleTy()))
    {
        ...
        llvm::PointerType* floatPtrType = IGCLLVM::getPointerType(floatDatType, ptrv->getType()->getPointerAddressSpace());
