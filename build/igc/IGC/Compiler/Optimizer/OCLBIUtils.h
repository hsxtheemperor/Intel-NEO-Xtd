...
namespace IGC
{
    ...
    public:
        ...
        llvm::Function* getFunctionDeclaration(llvm::GenISAIntrinsic::ID id, llvm::ArrayRef<llvm::Type*> Tys = /home/harshit9745/SFXFolder/Workspace-Code/build/igc/IGC/Compiler/Optimizer/OCLBIUtils.h);

        /// @brief  gets llvm function declaration for LLVM Intrinsic
        /// @param  Id          the wanted LLVM intrinsic
        /// @param  ptrTy       for intrinsic with overloaded types.
        /// @returns    llvm Function
        llvm::Function* getFunctionDeclaration(IGCLLVM::Intrinsic id, llvm::ArrayRef<llvm::Type*> Tys = /home/harshit9745/SFXFolder/Workspace-Code/build/igc/IGC/Compiler/Optimizer/OCLBIUtils.h);

        /// @brief  Creates llvm function call for LLVM Intrinsic and replace the
        ///         current instruction with the new function call.
        /// @param  Id          the wanted LLVM intrinsic
        /// @param  ptrTy       for intrinsic with overloaded types.
        void replaceCallInst(IGCLLVM::Intrinsic intrinsicName, llvm::ArrayRef<llvm::Type*> Tys = /home/harshit9745/SFXFolder/Workspace-Code/build/igc/IGC/Compiler/Optimizer/OCLBIUtils.h);
        ...
        /// @param  Id          the wanted GenISA_ISA intrinsic
        /// @param  ptrTy       for intrinsic with overloaded types.
        void replaceGenISACallInst(llvm::GenISAIntrinsic::ID intrinsicName, llvm::ArrayRef<llvm::Type*> Tys = /home/harshit9745/SFXFolder/Workspace-Code/build/igc/IGC/Compiler/Optimizer/OCLBIUtils.h);
