...
void ResolveOCLRaytracingBuiltins::defineOpaqueTypes() {
    ...
    SmallVector<Type*, 4> Tys{
        IGCLLVM::getPointerType(rtFenceTy, ADDRESS_SPACE_PRIVATE),
        IGCLLVM::getPointerType(rtGlobalsTy, ADDRESS_SPACE_GLOBAL),
        IGCLLVM::getPointerType(Type::getInt8Ty(C), ADDRESS_SPACE_GLOBAL),
        Type::getInt32Ty(C),
        Type::getInt32Ty(C)
    };
