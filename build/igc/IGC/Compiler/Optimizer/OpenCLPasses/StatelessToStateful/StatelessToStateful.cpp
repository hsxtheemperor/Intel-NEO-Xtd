...
void StatelessToStateful::promoteLoad(InstructionInfo& II)
{
    ...
    PointerType* pTy = IGCLLVM::getPointerType(I->getType(), II.getStatefulAddrSpace());
...
void StatelessToStateful::promoteStore(InstructionInfo& II)
{
    ...
    PointerType* pTy = IGCLLVM::getPointerType(dataVal->getType(), II.getStatefulAddrSpace());
