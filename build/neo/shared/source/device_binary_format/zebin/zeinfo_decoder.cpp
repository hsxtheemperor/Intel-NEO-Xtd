...
void populateKernelSourceAttributes(NEO::KernelDescriptor &dst, const KernelAttributesBaseT &attributes) {
    ...
    dst.kernelAttributes.flags.isInvalid = attributes.invalidKernel.hasValue();
    dst.kernelAttributes.flags.requiresWorkgroupWalkOrder = attributes.intelReqdWorkgroupWalkOrder.hasValue();
