...
inline std::enable_if_t<false == std::is_pointer_v<T>, T> readTokValue(const TokenHeader &token) {
    ...
    default:
        ...
        break;
    case 0:
        ret = {static_cast<T>(reinterpret_cast<const TokenBool &>(token).value())};
        break;
    case 1:
        ret = {static_cast<T>(reinterpret_cast<const TokenDword &>(token).value())};
        break;
    case 2:
        ret = {static_cast<T>(reinterpret_cast<const TokenQword &>(token).value())};
        break;
    }
    return ret;
}
...
inline std::enable_if_t<std::is_pointer_v<T>, T> readTokValue(const TokenHeader &token) {
    ...
    default:
        ...
        break;
    case 0:
        ret = {reinterpret_cast<T>(static_cast<uintptr_t>(reinterpret_cast<const TokenBool &>(token).value()))};
        break;
    case 1:
        ret = {reinterpret_cast<T>(static_cast<uintptr_t>(reinterpret_cast<const TokenDword &>(token).value()))};
        break;
    case 2:
        ret = {reinterpret_cast<T>(static_cast<uintptr_t>(reinterpret_cast<const TokenQword &>(token).value()))};
        break;
    }
    return ret;
}
