...
auto* _getBVHPtr(Value* arg_0, Value* arg_1, Value* arg_2, const Twine& _ReturnName = "")
{
  ...
  SetInsertPoint(BB_6);
  auto* V_12 = CreateIntToPtr(arg_0, IGCLLVM::getPointerType(_struct_RTStackFormat__BVH(*Ctx.getModule()), 2));
...
auto* _getRayFlagsSync_Xe(Value* arg_0, const Twine& _ReturnName = "")
{
  ...
  auto* V_2 = CreateBitCast(V_1, IGCLLVM::getPointerType(_igc_auto_struct_anon(*Ctx.getModule()), arg_0->getType()->getPointerAddressSpace()));
...
void _setRayFlagsSync_Xe(Value* arg_0, Value* arg_1)
{
  ...
  auto* V_3 = CreateBitCast(V_2, IGCLLVM::getPointerType(_igc_auto_struct_anon(*Ctx.getModule()), arg_0->getType()->getPointerAddressSpace()));
...
auto* _getInstanceLeaf_Xe(Value* arg_0, Value* arg_1, const Twine& _ReturnName = "")
{
  ...
  auto* V_10 = CreateIntToPtr(V_9, IGCLLVM::getPointerType(_struct_RTStackFormat__InstanceLeaf(*Ctx.getModule()), 1), _ReturnName);
  return V_10;
}
...
auto* _getInstanceContributionToHitGroupIndex_Xe(Value* arg_0, Value* arg_1, const Twine& _ReturnName = "")
{
  ...
  auto* V_8 = CreateAnd(V_7, getInt64(281474976710592));
  auto* V_9 = canonizePointer(V_8);
  auto* V_10 = CreateIntToPtr(V_9, IGCLLVM::getPointerType(_struct_RTStackFormat__InstanceLeaf(*Ctx.getModule()), 1));
...
void _writeBaryCentricToStorage_Xe(Value* arg_0, Value* arg_1, Value* arg_2)
{
  ...
  auto* V_5 = CreateSelect(arg_2, V_3, V_4);
  auto* V_6 = CreateBitCast(V_5, IGCLLVM::getPointerType(getInt64Ty(), arg_0->getType()->getPointerAddressSpace()));
  auto* V_7 = CreateBitCast(arg_1, IGCLLVM::getPointerType(getInt64Ty(), arg_1->getType()->getPointerAddressSpace()));
...
auto* _TransformWorldToObject_Xe(Value* arg_0, Value* arg_1, Value* arg_2, Value* arg_3, const Twine& _ReturnName = "")
{
  ...
  auto* V_15 = CreateIntToPtr(V_14, IGCLLVM::getPointerType(_struct_RTStackFormat__InstanceLeaf(*Ctx.getModule()), 1));
...
auto* _getObjWorldAndWorldObj_Xe(Value* arg_0, Value* arg_1, Value* arg_2, Value* arg_3, const Twine& _ReturnName = "")
{
  ...
  auto* V_12 = CreateIntToPtr(V_11, IGCLLVM::getPointerType(_struct_RTStackFormat__InstanceLeaf(*Ctx.getModule()), 1));
...
auto* _getPrimitiveIndex_Xe(Value* arg_0, Value* arg_1, Value* arg_2, const Twine& _ReturnName = "")
{
  ...
  auto* V_21 = CreateIntToPtr(V_13, IGCLLVM::getPointerType(_struct_RTStackFormat__QuadLeaf(*Ctx.getModule()), 1));
  ...
  auto* V_28 = CreateIntToPtr(V_13, IGCLLVM::getPointerType(_struct_RTStackFormat__ProceduralLeaf(*Ctx.getModule()), 1));
...
auto* _getGeometryIndex_Xe(Value* arg_0, Value* arg_1, Value* arg_2, const Twine& _ReturnName = "")
{
  ...
  auto* V_12 = CreateIntToPtr(V_9, IGCLLVM::getPointerType(_struct_RTStackFormat__ProceduralLeaf(*Ctx.getModule()), 1));
  auto* V_13 = CreateInBoundsGEP(_struct_RTStackFormat__ProceduralLeaf(*Ctx.getModule()), V_12, { getInt64(0), getInt32(0), getInt32(1) });
  auto* V_14 = CreateIntToPtr(V_9, IGCLLVM::getPointerType(_struct_RTStackFormat__QuadLeaf(*Ctx.getModule()), 1));
...
void _createTraceRayInlinePrologue_Xe(Value* arg_0, Value* arg_1, Value* arg_2, Value* arg_3, Value* arg_4, Value* arg_5, Value* arg_6)
{
  ...
  auto* V_11 = CreateBitCast(V_10, IGCLLVM::getPointerType(IGCLLVM::FixedVectorType::get(getFloatTy(), 8), arg_0->getType()->getPointerAddressSpace()));
  ...
  auto* V_13 = CreateBitCast(V_12, IGCLLVM::getPointerType(_igc_auto_struct_anon(*Ctx.getModule()), arg_0->getType()->getPointerAddressSpace()));
...
void _emitSingleRQMemRayWrite_Xe(Value* arg_0, Value* arg_1, Value* arg_2)
{
  ...
  auto* V_8 = CreateBitCast(V_7, IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()));
  auto* V_9 = CreateGEP(_struct_RTStackFormat__RTStack(*Ctx.getModule()), arg_1, { getInt64(0), getInt32(2), getInt32(0), getInt64(0) });
  auto* V_10 = CreateBitCast(V_9, IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()));
  CreateIntrinsic(Intrinsic::memcpy, { IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()), IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()), getInt64Ty() }, { V_8, V_10, getInt64(32), getFalse() }, nullptr);
  ...
  auto* V_12 = CreateBitCast(V_11, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_16 = CreateBitCast(V_15, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_17 = CreateLoad(getInt32Ty(), V_16);
  ...
  auto* V_22 = CreateBitCast(V_21, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_23 = CreateLoad(getInt32Ty(), V_22);
  ...
  auto* V_26 = CreateBitCast(V_25, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_30 = CreateBitCast(V_29, IGCLLVM::getPointerType(IGCLLVM::FixedVectorType::get(getInt32Ty(), 8), arg_0->getType()->getPointerAddressSpace()));
  ...
  auto* V_32 = CreateBitCast(V_31, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_36 = CreateBitCast(V_35, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_40 = CreateBitCast(V_39, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_44 = CreateBitCast(V_43, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
...
void _copyMemHitInProceed_Xe(Value* arg_0, Value* arg_1, Value* arg_2)
{
  ...
  auto* V_10 = CreateBitCast(arg_0, IGCLLVM::getPointerType(IGCLLVM::FixedVectorType::get(getInt32Ty(), 4), arg_0->getType()->getPointerAddressSpace()));
  ...
  auto* V_21 = CreateBitCast(V_20, IGCLLVM::getPointerType(IGCLLVM::FixedVectorType::get(getInt32Ty(), 4), arg_0->getType()->getPointerAddressSpace()));
  CreateStore(V_19, V_21);
  CreateBr(_JoinBB);
  SetInsertPoint(BB_5);
  auto* V_22 = CreateBitCast(arg_1, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_23 = CreateLoad(getInt32Ty(), V_22);
  ...
  auto* V_30 = CreateBitCast(V_29, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_31 = CreateLoad(getInt32Ty(), V_30);
  ...
  auto* V_36 = CreateBitCast(arg_0, IGCLLVM::getPointerType(IGCLLVM::FixedVectorType::get(getInt32Ty(), 4), arg_0->getType()->getPointerAddressSpace()));
  ...
  auto* V_38 = CreateBitCast(V_37, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_42 = CreateBitCast(V_41, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
  ...
  auto* V_46 = CreateBitCast(V_45, IGCLLVM::getPointerType(getInt32Ty(), arg_1->getType()->getPointerAddressSpace()));
...
auto* _syncStackToShadowMemory_Xe(Value* arg_0, Value* arg_1, Value* arg_2, Value* arg_3, const Twine& _ReturnName = "")
{
  ...
  SetInsertPoint(BB_4);
  auto* V_8 = CreateBitCast(arg_1, IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_9 = CreateBitCast(arg_0, IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()));
  ...
  auto* V_15 = CreateBitCast(V_14, IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_16 = CreateGEP(_struct_RTStackFormat__RTStack(*Ctx.getModule()), arg_0, { getInt64(0), getInt32(1), getInt32(0) });
  auto* V_17 = CreateBitCast(V_16, IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()));
  CreateIntrinsic(Intrinsic::memcpy, { IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()), IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()), getInt64Ty() }, { V_15, V_17, getInt64(32), getFalse() }, nullptr);
  auto* V_18 = CreateGEP(_struct_RTStackFormat__RTStack(*Ctx.getModule()), arg_1, { getInt64(0), getInt32(3), getInt32(0), getInt64(0) });
  auto* V_19 = CreateBitCast(V_18, IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()));
  auto* V_20 = CreateGEP(_struct_RTStackFormat__RTStack(*Ctx.getModule()), arg_0, { getInt64(0), getInt32(3), getInt32(0), getInt64(0) });
  auto* V_21 = CreateBitCast(V_20, IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()));
  CreateIntrinsic(Intrinsic::memcpy, { IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()), IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()), getInt64Ty() }, { V_19, V_21, getInt64(24), getFalse() }, nullptr);
  ...
  SetInsertPoint(BB_6);
  CreateIntrinsic(Intrinsic::memcpy, { IGCLLVM::getPointerType(getInt8Ty(), arg_1->getType()->getPointerAddressSpace()), IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()), getInt64Ty() }, { V_8, V_9, getInt64(32), getFalse() }, nullptr);
  CreateBr(BB_7);
  SetInsertPoint(BB_7);
...
auto* _getHitAddress_Xe(Value* arg_0, Value* arg_1, const Twine& _ReturnName = "")
{
  ...
  auto* V_3 = CreateInBoundsGEP(_struct_RTStackFormat__RTStack(*Ctx.getModule()), arg_0, { getInt64(0), getInt32(1) });
  auto* V_4 = CreateSelect(arg_1, V_2, V_3);
  auto* V_5 = CreateBitCast(V_4, IGCLLVM::getPointerType(getInt8Ty(), arg_0->getType()->getPointerAddressSpace()), _ReturnName);
  return V_5;
}
