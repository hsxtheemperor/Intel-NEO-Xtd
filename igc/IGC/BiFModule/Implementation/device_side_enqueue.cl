...
{
  union { __spirv_Queue spirv_q; queue_t ocl_q; } q_cast;
  q_cast.spirv_q = Queue;
  return __intel_enqueue_marker_impl(q_cast.ocl_q, NumEvents, (const generic clk_event_t*)(size_t)WaitEvents, (generic clk_event_t*)(size_t)RetEvent);
}
...
{
    union { size_t raw_ptr; __spirv_Queue spirv_q; } q_cast;
    q_cast.raw_ptr = (size_t)__builtin_IB_get_default_device_queue();
    return q_cast.spirv_q;
}
