...
INLINE __spirv_DeviceEvent IGIL_CreateUserEvent()
{
    ...
    else
    {
        ...
        events[(int)(size_t)__builtin_astype(newEvent, __private void*)].m_eventType = IGIL_EVENT_TYPE_USER;
        events[(int)(size_t)__builtin_astype(newEvent, __private void*)].m_state = CL_SUBMITTED;
    }
