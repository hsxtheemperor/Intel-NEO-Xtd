...
public:
  ...
  ///
  // In DIE.hpp
  const ::llvm::MCExpr *getValue() const { return (const ::llvm::MCExpr *)Expr; }
...
public:
  ...
  ///
  // In DIE.hpp
const ::llvm::MCExpr *getValue() const { return (const ::llvm::MCExpr *)Label; }
...
public:
  ...
  /// EmitValue - Embed block data into the process.
  void EmitValue(StreamEmitter *AP, ::llvm::dwarf::Form Form) const override;

  /// SizeOf - Determine size of block data in bytes.
  unsigned SizeOf(StreamEmitter *AP, ::llvm::dwarf::Form Form) const override;
