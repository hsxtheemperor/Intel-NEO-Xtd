...
import argparse
from igc.IGC.GenISAIntrinsics.generator.Intrinsic_definition_objects import *
from igc.IGC.GenISAIntrinsics.generator.Intrinsic_utils import *
...
def translate_attribute_list(attribute):
    ...
    attribute_map = {
        "NoUnwind": set([ AttributeID.NoUnwind ]),
        "NoMem": set([ AttributeID.NoUnwind, AttributeID.ReadNone ]),
        "ReadMem": set([ AttributeID.NoUnwind, AttributeID.ReadOnly ]),
        "ReadArgMem": set([ AttributeID.NoUnwind, AttributeID.NoUnwind, AttributeID.ReadOnly ]),
        "WriteArgMem": set([ AttributeID.NoUnwind, AttributeID.WriteOnly, AttributeID.NoUnwind ]),
        "WriteMem": set([ AttributeID.NoUnwind, AttributeID.WriteOnly ]),
        "ReadWriteArgMem": set([ AttributeID.NoUnwind, AttributeID.NoUnwind ]),
        ...
        "NoUnwind": set([ AttributeID.NoUnwind, AttributeID.NoUnwind ]),
