...
#define TYPE(T) ENUM_BITSET_VALUE(T, uint32_t)
...
#define UNWRAP_TUPLE(...)                                                      \
  { __VA_ARGS__ }
#define IGA_REGISTER_SPEC(PLAT_LO, PLAT_HI, REGNAME, SYNTAX, DESCRIPTION,      \
                          REGNUM7_4, REGNUM_BASE, ACC_GRAN, NUM_REGS,          \
                          NUM_BYTE_PER_REG)                                    \
  {                                                                            \
    REGNAME, SYNTAX, DESCRIPTION, REGNUM7_4, REGNUM_BASE, PLAT_LO, PLAT_HI,    \
        ACC_GRAN, NUM_REGS, UNWRAP_TUPLE NUM_BYTE_PER_REG                      \
  }
// for <= some platform (whatever our lowest platform is
#define IGA_REGISTER_SPEC_LE(PLAT_HI, REGNAME, SYNTAX, DESCRIPTION, REGNUM7_4, \
                             REGNUM_BASE, ACC_GRAN, NUM_REGS,                  \
                             NUM_BYTE_PER_REG)                                 \
  IGA_REGISTER_SPEC(Platform::GEN6, PLAT_HI, REGNAME, SYNTAX, DESCRIPTION,     \
                    REGNUM7_4, REGNUM_BASE, ACC_GRAN, NUM_REGS,                \
                    NUM_BYTE_PER_REG)
// for >= some platform (up to the highest)
#define IGA_REGISTER_SPEC_GE(PLAT_LO, REGNAME, SYNTAX, DESCRIPTION, REGNUM7_4, \
                             REGNUM_BASE, ACC_GRAN, NUM_REGS,                  \
                             NUM_BYTE_PER_REG)                                 \
  IGA_REGISTER_SPEC(PLAT_LO, Platform::FUTURE, REGNAME, SYNTAX, DESCRIPTION,   \
                    REGNUM7_4, REGNUM_BASE, ACC_GRAN, NUM_REGS,                \
                    NUM_BYTE_PER_REG)
// a specification valid on all platforms
#define IGA_REGISTER_SPEC_UNIFORM(REGNAME, SYNTAX, DESCRIPTION, REGNUM7_4,     \
                                  REGNUM_BASE, ACC_GRAN, NUM_REGS,             \
                                  NUM_BYTE_PER_REG)                            \
  IGA_REGISTER_SPEC(Platform::GEN6, Platform::FUTURE, REGNAME, SYNTAX,         \
                    DESCRIPTION, REGNUM7_4, REGNUM_BASE, ACC_GRAN, NUM_REGS,   \
                    NUM_BYTE_PER_REG)

// ordered by encoding of RegNum[7:4]
// newest platforms first
static const struct RegInfo REGISTER_SPECIFICATIONS[] = {
    IGA_REGISTER_SPEC_LE(Platform::GEN11, RegName::GRF_R, "r", "General", 0, 0,
                         1, 128, (0)),

    IGA_REGISTER_SPEC_GE(Platform::XE, RegName::GRF_R, "r", "General", 0,
    ...
    IGA_REGISTER_SPEC_LE(Platform::GEN11, RegName::ARF_ACC, "acc",
                         "Accumulator", 0x2, 0, 1, 2, (32, 32)),
    IGA_REGISTER_SPEC(Platform::XE, Platform::XE, RegName::ARF_ACC, "acc",
                      "Accumulator", 0x2, 0, 1, 8,
                      (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC(Platform::XE_HP, Platform::XE_HP, RegName::ARF_ACC, "acc",
                      "Accumulator", 0x2, 0, 1, 8,
                      (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC(Platform::XE_HPG, Platform::XE_HPG, RegName::ARF_ACC,
                      "acc", "Accumulator", 0x2, 0, 1, 8,
                      (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC_GE(
        Platform::XE_HPC, RegName::ARF_ACC, "acc", "Accumulator", 0x2, 0, 1, 16,
        (64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64)),
    IGA_REGISTER_SPEC_LE(Platform::GEN11, RegName::ARF_MME, "mme", "Math Macro",
                         0x2, 2, // offset by 2 "acc2-9"
                         4, 8, (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC(Platform::XE, Platform::XE, RegName::ARF_MME, "mme",
                      "Math Macro", 0x2, 8, // offset by 8 "acc8-15"
                      4, 8, (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC(Platform::XE_HP, Platform::XE_HP, RegName::ARF_MME, "mme",
                      "Math Macro", 0x2, 8, // offset by 8 "acc8-15"
                      4, 8, (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC(Platform::XE_HPG, Platform::XE_HPG, RegName::ARF_MME,
                      "mme", "Math Macro", 0x2, 8, // offset by 8 "acc8-15"
                      4, 8, (32, 32, 32, 32, 32, 32, 32, 32)),
    IGA_REGISTER_SPEC_GE(Platform::XE_HPC, RegName::ARF_MME, "mme",
                         "Math Macro", 0x2, 8, // offset by 8 "acc8-15"
                         4, 8, (64, 64, 64, 64, 64, 64, 64, 64)),

    IGA_REGISTER_SPEC_LE(Platform::XE_HPG, RegName::ARF_F, "f", "Flag Register",
                         0x3, 0, 2, 2, (4, 4)),
    IGA_REGISTER_SPEC_GE(Platform::XE_HPC, RegName::ARF_F, "f", "Flag Register",
                         0x3, 0, 2, 4, (4, 4, 4, 4)),

    IGA_REGISTER_SPEC_GE(Platform::GEN7P5, RegName::ARF_CE, "ce",
                         "Channel Enable", 0x4, 0, 4, 0, (4)),
    ...
    IGA_REGISTER_SPEC(Platform::GEN7P5, Platform::GEN7P5, RegName::ARF_SP, "sp",
                      ...
                      (2 * 4)), // two subregisters of 4 bytes each
    ...
    IGA_REGISTER_SPEC_UNIFORM(RegName::ARF_N, "n", "Notification Register", 0x9,
                              0, 4, 1, (3 * 4)), // n0.{0..2}:d
    ...
    IGA_REGISTER_SPEC_GE(Platform::GEN10, RegName::ARF_TM, "tm",
                         ...
                         (5 * 4)), // tm0.{0..4}:d
    IGA_REGISTER_SPEC_LE(Platform::GEN9, RegName::ARF_TM, "tm",
                         "Timestamp Register", 0xC, 0, 4, 1,
                         (4 * 4)), // tm0.{0..3}:d
    ...
    // fc4.0     call mask
    IGA_REGISTER_SPEC(Platform::GEN7P5, Platform::GEN11, RegName::ARF_FC, "fc",
                      "Flow Control", 0xD, 0, 4, 5,
                      (4 * 32, 4 * 1, 4 * 1, 4 * 4, 4 * 1)),
//  EU GOTO/JOIN instruction latency improvement HAS397165 removes two flow
//  control registers
...
const OpSpec &Model::lookupOpSpecByCode(unsigned opcode) const {
  ...
  // }
  for (int i = (int)Op::FIRST_OP; i <= (int)Op::LAST_OP; i++) {
    if (opsArray[i].op != Op::INVALID && opsArray[i].opcode == opcode) {
      return opsArray[i];
    }
  }
...
template <int N>
static unsigned getBitsFromFragments(const uint64_t *qws,
                                     const Fragment ff[N]) {
  unsigned bits = 0;
...
const OpSpec &Model::lookupOpSpecFromBits(const void *bits,
...
uint32_t Model::getNumGRF() const { return getRegCount(RegName::GRF_R); }

uint32_t Model::getNumFlagReg() const { return getRegCount(RegName::ARF_F); }
...
const RegInfo *Model::lookupArfRegInfoByRegNum(uint8_t regNum7_0) const {
  ...
  for (const RegInfo &ri : REGISTER_SPECIFICATIONS) {
    ...
    } else if (ri.regNum7_4 ==
                   ((uint32_t)regNum7_0 >> 4) && // RegNum[7:4] matches AND
               ri.supportedOn(platform))         // platform matches
    {
      int shiftedRegNum = regNum - ri.regNumBase;
      if (ri.regName == RegName::ARF_MME &&
          !ri.isRegNumberValid(shiftedRegNum) && arfAcc != nullptr) {
...
static constexpr Model MODEL_GEN7P5(Platform::GEN7P5, &MODEL_GEN7P5_OPSPECS[0],
                                    "7p5", "hsw");
static constexpr Model MODEL_GEN8(Platform::GEN8, &MODEL_GEN8_OPSPECS[0], "8",
                                  "bdw");
static constexpr Model MODEL_GEN9(Platform::GEN9, &MODEL_GEN9_OPSPECS[0], "9",
                                  "skl");
static constexpr Model MODEL_GEN10(Platform::GEN10, &MODEL_GEN10_OPSPECS[0],
                                   "10", "cnl");
static constexpr Model MODEL_GEN11(Platform::GEN11, &MODEL_GEN11_OPSPECS[0],
                                   "11", "icl");
static constexpr Model MODEL_XE(Platform::XE, &MODEL_XE_OPSPECS[0], "12p1",
                                "xe", "xelp", "tgl", "tgllp", "dg1");
static constexpr Model
    MODEL_XE_HP(Platform::XE_HP, &MODEL_XE_HP_OPSPECS[0], "12p5", "xehp"
    );
...
static constexpr Model
    MODEL_XE_HPC(Platform::XE_HPC, &MODEL_XE_HPC_OPSPECS[0], "12p72", "xehpc"
    );
